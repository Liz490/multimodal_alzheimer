...
def plot_bar_exp(df, legend=True, binary=True, cmap_1=cmap_disc_middle, cmap_2=cmap_disc_light):
    fig, ax = plt.subplots(figsize=(11, 6))
...
def plot_bar_exp_cc(df, legend=True, binary=True, cmap_1=cmap_disc_middle, cmap_2=cmap_disc_light, hatches: tuple=None):
    fig, ax = plt.subplots(figsize=(11, 6))
    ...
    kwargs = {
        ...
        'capsize': 2,
        'ecolor': 'black',
        'color': ['#D8BFD8', '#D8BFD8', '#D8BFD8', '#D8BFD8'],
    }
